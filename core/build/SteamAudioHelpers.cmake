...
function (get_host_bin_subdir BIN_SUBDIR)
	# Use platform-native suffix for native build tools (e.g., flatc compiler)
	# This works correctly on both x64 and ARM64 hosts
	if (CMAKE_HOST_WIN32)
		set(${BIN_SUBDIR} windows-native PARENT_SCOPE)
	elseif (CMAKE_HOST_APPLE)
		set(${BIN_SUBDIR} osx-native PARENT_SCOPE)
	else()
		set(${BIN_SUBDIR} linux-native PARENT_SCOPE)
	endif()
endfunction()
